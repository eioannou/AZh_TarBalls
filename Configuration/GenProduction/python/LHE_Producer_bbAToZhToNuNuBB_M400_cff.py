...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/work/a/aioannou/GenProductions/genproductions/bin/MadGraph5_aMCatNLO/FixingStation/bbAToZhToNuNuBB_gridpacks/bbAToZhToNuNubbbb_4f_M400_tarball.tar.xz'),
